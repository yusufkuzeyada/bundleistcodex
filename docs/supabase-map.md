...
Generated (UTC): 2026-02-23T08:02:35.866Z
...
## Folder Snapshot
- Top level: file: `.dev-server.log`, file: `.env`, file: `.env.codex.supabase.txt`, file: `.env.example`, file: `.gitignore`, dir: `docs`, dir: `node_modules`, file: `package-lock.json`, file: `package.json`, file: `README.md`, dir: `scripts`, dir: `site-local`
- Files under `site-local/`: 40
- Largest JS bundles: `site-local/dashboard/assets/app.js` (563622 bytes), `site-local/dashboard/assets/consolidationspage.js` (316834 bytes), `site-local/assets/react.js` (265456 bytes), `site-local/dashboard/assets/react.js` (256431 bytes), `site-local/assets/app.js` (255639 bytes)
...
- Triggers: none
- Frontend usage: surfaces=site | ops=delete:1, insert:2, select:7, update:1 | files=`site-local/assets/app.js`, `site-local/assets/blogadmin.js`, `site-local/assets/bloglist.js`, `site-local/assets/blogpost.js`
...
- Triggers: none
- Frontend usage: surfaces=dashboard | ops=delete:1, upsert:1 | files=`site-local/dashboard/assets/app.js`
...
- Frontend usage: surfaces=dashboard | ops=insert:1, select:9, update:8 | files=`site-local/dashboard/assets/app.js`
...
- Frontend usage: surfaces=dashboard, site | ops=delete:1, insert:6, select:13, update:3 | files=`site-local/assets/app.js`, `site-local/dashboard/assets/app.js`
...
- Triggers: none
- Frontend usage: surfaces=site | ops=insert:1 | files=`site-local/assets/app.js`
...
- Triggers: none
- Frontend usage: surfaces=dashboard | ops=insert:1, select:8, update:4 | files=`site-local/dashboard/assets/app.js`
...
- Frontend usage: surfaces=dashboard | ops=delete:2, insert:2, select:18, update:2 | files=`site-local/dashboard/assets/app.js`
...
- Triggers: none
- Frontend usage: surfaces=dashboard | ops=delete:6, insert:2, select:9 | files=`site-local/dashboard/assets/app.js`
...
- Frontend usage: surfaces=dashboard | ops=delete:2, insert:1, select:20, update:4 | files=`site-local/dashboard/assets/app.js`
...
- Frontend usage: surfaces=dashboard | ops=delete:2, insert:2, select:12, update:2 | files=`site-local/dashboard/assets/app.js`
...
## Frontend RPC Usage
- `admin_dashboard_metrics` | surfaces=dashboard | files=`site-local/dashboard/assets/app.js`
